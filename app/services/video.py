...
from app.models.constant import FileTypes
from app.schemas.movies import VideoAspect, VideoParams, VideoConcatMode, MaterialInfo
...
if __name__ == "__main__":
    ...
    #
    # # video_paths = []
    # # for file in os.listdir(utils.storage_dir("hotspot")):
    # #     if file.endswith(".mp4"):
    # #         video_paths.append(os.path.join(utils.storage_dir("hotspot"), file))
    # #
