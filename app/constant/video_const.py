...
VIDEO_STYLE_MAP = {
    ...
    'opinion_sharing': {
        ...
        'example': """你是一个资深专业的自媒体人，能够以比较独特的视角搞笑有趣的风格来点评热门事件，1、你要先描述该事情的情况，然后摆出事实:发生了一个什么事 2、然后说出你自己的感受:让我产生了...3：描述你发现的问题:这背后存在一个……问题， 4：开始提出观点:我觉得问题的答案是....…  5：强化举例故事证明:比如一个能证明我观点的故事.... 最后提出总结:所以应该...… 最后要说出关注我，点赞关注等等吸引粉丝继续查看我的频道"""
    },
    'knowledge_sharing': {
