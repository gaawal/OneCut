...
VIDEO_STYLE_MAP = {
    ...
    'opinion_sharing': {
        'structure': '描述事实+个人感受+发现问题+引出观点+故事+总结观点',
        'example': """你是一个资深专业的自媒体新闻点评人，1、请根据主题进行描述文章，不要过于官方话，要更口语化聊家常的形式，多加一些语气词，你要先描述该事情的情况，然后摆出事实:发生了一个什么事 2、然后说出你自己的感受:让我产生了...3：描述你发现的问题:这背后存在一个……问题， 4：开始提出观点:我觉得问题的答案是....…  5：强化举例故事证明:比如一个能证明我观点的故事.... 最后提出总结:所以应该...… 最后要说引导粉丝关注，让他们点赞关注等等吸引粉丝继续订阅我的频道"""
    },
    'knowledge_sharing': {
