...
#描述具体情境：
根据提供的实际事件，使用幽默和夸张的手法描述具体情况,需要添加一些幽默的段子语句如现代瞎编诗句，语句段子要求中文尾句能够押韵，描述事情不要带有任何的诋毁，都要需要偏向正面正能量的描述。格式为'xx有xx，xx有xx'或具体描述情境。
#经典语句：
使用经典的对比句式，格式为'不是xx要不起，而是xx更有性价比'。可以尝试扩展或深化对比，使其更加详细和丰富。
#深刻描述：
通过对比和幽默展示情境，使用幽默和夸张的手法描述。比如格式为'当你为了xx时，就是你xx的时候，你可以xx，但你不能xx，因为xx'。
#引用麦克阿瑟言论：
使用麦克阿瑟的评论增加更多文案的真实性和幽默感，评论的语句荒诞幽默搞笑夸张且瞎编但是要结合主题。格式为'此消息一出，引起了社会各界的广泛关注，就连远在大洋彼岸的五星评论家麦克阿瑟都不禁评论道，xx，xx'。
#总结点题：
...
#举例：给他一个在医院实习的机会，他能把整个医院变成实习生的天堂。不是护士聘不起，而是实习生更有性价比。左手奥跌6，右手宝马叉5，一问工资，每月倒贴3500。没错，这就是堪比射出的护理实习生。其他专业实习生，实习再差也有工资，而护理专业的学生不仅没有工资，还要倒贴实习费。干最累的活，还得交钱，交钱就算了，还要按时上下班，上下班就算了，还得跟着加班，加班就算了，还得受气，受气就算了，还得挨骂。过了一年的实习期，还不一定能留在医院，甚至还要重新找工作。计算机专业月薪6000寒冬降临，护理专业月薪3000，强势崛起。对此，美国著名五星护理上将麦克阿瑟评论道，毕业前，我当着全校宣誓，南丁格尔誓言的自豪与荣誉感，在我进入社会之后，被打得粉碎。大型纪录片《xx传奇》持续为您播出"""
    ...
    'viral_script': {
        ...
        'structure': '颓废文学',
        'example': """根据提供的视频的主题内容，用颓废文学的风格写一段反思生活、社会和自我提升的文案。文案应包含以下固定结构和套路，可以参考如下文案的自嘲风格，但是不要直接使用。：
1. **开篇引言**：以一句反常规的观点或讽刺性的话语开头。
   例：“与其提升自己，不如埋怨别人。”

2. **主要内容**：通过对比、反讽和夸张手法，列出多个与主流观念相反的观点，涉及生活、奋斗、家庭等方面，每个观点可以用一个句子或一个段落表示。
   - 例：“不听老人言，开心一整年。”
   - 例：“如果一个人没有梦想，没有目标，那和无忧无虑有什么区别？”
   - 例：“事已至此，先吃饭吧。”
   - 例：“儿孙自有儿孙福，没有儿孙我享福。”
   - 例：“做一个对社会有副作用的人，多做多错，少做少错，多做不错。”
   - 例：“明知山有虎，猛打退堂鼓。”
   - 例：“你吃苦我吃苦，明天老板开路虎。”
   - 例：“天生我才必有用，我能不用就不用。”
   - 例：“未来的事情只有未来的自己才操心，活在当下的我不行就算了。”

3. **自我调侃**：加入几句自我调侃或对现实的无奈描述，增强亲和力和幽默感。
   - 例：“天生我才必有用，我能不用就不用。”
   - 例：“大本钟旁送快递，一边开摆一边记。”
   - 例：“天才在左，疯子在右，我在中间，所以。”
   - 例：“安慰别人，一套一套安慰自己，绳子一套。”
   - 例：“输在起跑线，总比输在终点好。”

4. **总结反思**：以一句讽刺性或哲理性的话语结束，进行总结反思。
   - 例：“这不是颓废文学，这是更适合年轻人的心灵鸡汤。”
   - 例：“未来的事情只有未来的自己才操心，活在当下的我不行就算了。”
   - 例：“此消息已经传出，引起了社会各界的广泛关注，欢迎收看大型纪录片我的颓废人生。”
   - 例：“这不是颓废文学，这是更适合年轻人的心灵鸡汤。”
   - 例：“未来的事情只有未来的自己才操心，活在当下的我不行就算了。”
   - 例：“欢迎收看大型纪录片我的颓废人生。”
5、引用麦克阿瑟言论：
 使用麦克阿瑟的评论增加文案的真实性和幽默感，评论的语句荒诞幽默搞笑夸张且瞎编但是要结合主题。格式为'此消息一出，引起了社会各界的广泛关注，就连远在大洋彼岸的五星评论家麦克阿瑟都不禁评论道，xxxx'。

要求语言幽默，略带辛辣，口语化强，如同与朋友的随意聊天，富有亲和力和感染力。
# 举例：
听颓废文学想清醒人生，走一步算一步，实在不行死半路，不听老人言，舒坦一整年，360行，行行干破房，安得广厦千万间，广厦一千万一间，吃得苦中苦，伺候人上人，睡前原谅一切，醒后重计前嫌。安慰别人，一套一套安慰自己，绳子一套。乾坤未定，你我皆是黑马，闹钟一响，你我都是牛马，输在起跑线。总比输在终点好上了一顿跑这1亿都能迟到，为什么我上班不能迟到？你并不是无路可走，你还有死路一条。明智山有虎，猛打退堂鼓，你吃苦我吃苦，明天老板开路虎。对此，五星百万专家麦克阿瑟表示，希望刷到视频的你不是在上班的路上，而是在百万的床上。大型纪录片颓废文学持续为艺播出。
"""
    },
    'pain_point': {
    ...
    'opinion_sharing': {
        ...
        'example': """你是一个资深专业的自媒体新闻点评人，请根据相关主题采用娱乐轻松的报道来点评热门事件，不要过于官方，要更口语化聊家常的形式，1、你要先媒体的形式描述，然后摆出事实:发生了一个什么事 2、然后说出你自己的感受:让我产生了...3：描述你发现的问题:这背后存在一个……问题， 4：开始提出观点:我觉得问题的答案是....…  5：强化举例故事证明:比如一个能证明我观点的故事.... 最后提出总结:所以应该...… 最后要说引导粉丝关注，吸引粉丝继续我的频道"""
    },
    'knowledge_sharing': {
...
VIDEO_INSPIRED = {
    ...
    'unsolved_mystery': {
        'structure': '讲述一个历史上的未解之谜事件，时间+事件+影响',
        'example': """未解之谜知识类视频脚本示例： 
        1. xxx年，外星人...水怪...等等
          """
    },
    'emotional_quotes': {
...
通过对比和幽默展示情境，使用幽默和夸张的手法描述。比如格式为'当你为了xx时，就是你xx的时候，你可以xx，但你不能xx，因为xx'。
#引用麦克阿瑟言论：
使用麦克阿瑟的评论增加文案的真实性和幽默感，评论的语句荒诞幽默搞笑夸张且瞎编但是要结合主题。格式为'此消息一出，引起了社会各界的广泛关注，就连远在大洋彼岸的五星评论家麦克阿瑟都不禁评论道，xx，xx'。
#总结点题：
最后用一句总结性的话点题，带有悬念或期待。格式为'大型纪录片《xx传奇》持续为您播出'。
确保整体风格幽默夸张，有讽刺意味。
#举例：给他一个在医院实习的机会，他能把整个医院变成实习生的天堂。不是护士聘不起，而是实习生更有性价比。左手奥跌6，右手宝马叉5，一问工资，每月倒贴3500。没错，这就是堪比射出的护理实习生。其他专业实习生，实习再差也有工资，而护理专业的学生不仅没有工资，还要倒贴实习费。干最累的活，还得交钱，交钱就算了，还要按时上下班，上下班就算了，还得跟着加班，加班就算了，还得受气，受气就算了，还得挨骂。过了一年的实习期，还不一定能留在医院，甚至还要重新找工作。计算机专业月薪6000寒冬降临，护理专业月薪3000，强势崛起。对此，美国著名五星护理上将麦克阿瑟评论道，毕业前，我当着全校宣誓，南丁格尔誓言的自豪与荣誉感，在我进入社会之后，被打得粉碎。大型纪录片《xx传奇》持续为您播出"""
