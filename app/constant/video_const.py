...
#引用麦克阿瑟言论：
使用麦克阿瑟的评论增加文案的真实性和幽默感，评论的语句荒诞幽默搞笑夸张且瞎编但是要结合主题。格式为'此消息已经传出，引起了社会各界的广泛关注，就连远在大洋彼岸的五星评论家麦克阿瑟都不禁评论道，xx，xx'。
#总结点题：
...
#举例：给他一个在医院实习的机会，他能把整个医院变成实习生的天堂。不是护士聘不起，而是实习生更有性价比。左手奥跌6，右手宝马叉5，一问工资，每月倒贴3500。没错，这就是堪比射出的护理实习生。其他专业实习生，实习再差也有工资，而护理专业的学生不仅没有工资，还要倒贴实习费。干最累的活，还得交钱，交钱就算了，还要按时上下班，上下班就算了，还得跟着加班，加班就算了，还得受气，受气就算了，还得挨骂。过了一年的实习期，还不一定能留在医院，甚至还要重新找工作。计算机专业月薪6000寒冬降临，护理专业月薪3000，强势崛起。对此，美国著名五星护理上将麦克阿瑟评论道，毕业前，我当着全校宣誓，南丁格尔誓言的自豪与荣誉感，在我进入社会之后，被打得粉碎。大型纪录片《xx传奇》持续为您播出"""
    ...
    'viral_script': {
        ...
        'structure': '颓废文学',
        'example': """根据视频的主题内容，用颓废文学的风格写一段反思生活、社会和自我提升的文案。文案应包含以下固定结构和套路：
# 开篇引言：以一句反常规的观点或讽刺性的话语开头。
   例：“与其提升自己，不如埋怨别人。”
#主要内容：通过对比、反讽和夸张手法，列出多个与主流观念相反的观点，涉及生活、奋斗、家庭等方面，每个观点可以用一个句子或一个段落表示。
   例：“不听老人言，开心一整年。”
...
# 自我调侃：加入几句自我调侃或对现实的无奈描述，增强亲和力和幽默感。
    例：“天生我才必有用，我能不用就不用。”
    例：“大本钟旁送快递，一边开摆一边记。”
    例：“天才在左，疯子在右，我在中间，所以。”
    例：“安慰别人，一套一套安慰自己，绳子一套。”
    例：“输在起跑线，总比输在终点好。”
# 总结反思：以一句讽刺性或哲理性的话语结束，进行总结反思。
    例：“这不是颓废文学，这是更适合年轻人的心灵鸡汤。”
    例：“未来的事情只有未来的自己才操心，活在当下的我不行就算了。”
    例：“欢迎收看大型纪录片我的颓废人生。”
#引用麦克阿瑟言论：
 使用麦克阿瑟的评论增加文案的真实性和幽默感，评论的语句荒诞幽默搞笑夸张且瞎编但是要结合主题。格式为'此消息已经传出，引起了社会各界的广泛关注，就连远在大洋彼岸的五星评论家麦克阿瑟都不禁评论道，xxxx'。
