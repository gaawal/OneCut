...
VIDEO_STYLE_MAP = {
    'generic': {
        ...
        'example': """##视频脚本开头话术的约束任选其一：
        1.揭秘好奇型话术:我今天给大家揭秘一下xxx，先收藏，以免以后找不到!
                     本质:利用人性的好奇心+视频的划走成本，让你觉得看了也不亏。
        2.千万叛逆型话术:千万不要再相信那些博主说xxxxx! 
                     本质:利用了人的规避心态以及风险倾向，觉得可以避开这些坑。
        3.被上了一课型话术:我今天真的被水果店老板上了一课，50元5个橘子你敢相信嘛?
                     本质:这样的开头非常合适叙述故事作为开端，用起来非常自然。
        4.你有xx经历型话术:你有xxxx的经历吗?
                     本质:经历这个词就能让人产生共鸣，如果再表现出来，那效果就太好了!
        5.经历体验型话术:我第一次一个人拿着500块去北京找工作是一种什么样的体验。
                     本质:这种开头合适作为VLOG为开头，更加的贴近现实生活。 
        6.避雷干货型话术:宝马的这个通病你要是了解，肯定能为你省下不少冤枉钱。
